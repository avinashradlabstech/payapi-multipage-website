...
const Navbar = () => {
  ...
  return (
    <nav className=" top-0 z-50 px-6 py-10  sm:mx-auto ">
      <div className="container mx-auto flex justify-between items-center max-w-[327px] sm:max-w-689 lg:max-w-1110">
       <a href="/"> <Logo
          width="135"
          height="38"
          type="dark"
