...
const FooterMenu: React.FC = () => {
  return (
    <>
      <div className="footer-menu flex relative bg-secondary-mirage-blue overflow-hidden ">
        <div className="flex flex-col items-center justify-center sm:flex-row sm:justify-between mx-auto sm:gap-150 lg:gap-642 lg:max-w-1110">
          <div className="flex flex-col items-center gap-6 sm:flex-row lg:flex-row lg:items-center sm:gap-18">
            <a href="/">
              ...
              <Logo
                ...
                height="38"
                type="light"
                appliedClassName="mobile-logo px-120 py-41 sm:px-39 sm:py-31 lg:px-0"
              />
            </a>
