...
const Pageheading: React.FC<PageheadingData> = ({ heading, additionalCss }) => {
  return (
      ...
      <div
        className={` flex justify-center items-center mx-auto max-w-[327px] sm:pt-[80px] sm:max-w-[573px] lg:max-w-[546px] lg:justify-start lg:items-start lg:m-0 ${additionalCss}`}
      >
